...
export const SendToken = ({abi}) => {
    ...
    const sendCoins = async () => {
        ...
        if (amount === "" || destination === "") {
            console.error("you need to provide a destination address and an amount !")
            return;
        }
    ...
    return <div className="flex-col flex bg-white w-9/12 max-w-xl rounded-2xl p-2">
        ...
        <button className="bg-yellow-300 rounded-2xl mx-2 px-2 p-2 mb-2 " onClick={sendCoins}>Send</button>
    </div>
